    ...
    if params[:applyAll]==true
      ...
      for current_iteration_number in 2010..2025 do
        if params[:companyGeoData]
          ...
          @CompanyGeo = CompanyGeo.where("company_id =:company AND year =:year",{:company => params[:selected_company],:year=>current_iteration_number})
          @CompanyGeo.delete_all
        end
      end
    else
      ...
      if @company_revenue.count != 0
        ...
        if params[:companyGeoData]
          ...
          @CompanyGeo = CompanyGeo.where("company_id =:company AND year =:year",{:company => params[:selected_company],:year=>params[:selected_year]})
          @CompanyGeo.delete_all
        end
