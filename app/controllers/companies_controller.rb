class CompaniesController < ApplicationController
  ...
  def getbyName
    ...
    @company.each_with_index do |value, index|
      ...
      if @year == 'All'
          ...
          @company_names_array[index] = @company
      else
    ...
    #sorting code
    if(@sort=='asc')
      @company_names_array.sort_by!{ |m| m[:"#{@colmName}"] }
    else
      @company_names_array.sort! { |x,y| y[:"#{@colmName}"] <=> x[:"#{@colmName}"] }
    end

    @company_names_array2 = []
    @company_names_array.each_with_index do |value, index|
      
      @company = Company.where(["id = ?",value.id]).first
      @company_names_array2[index] = @company.to_json(:include =>[:confidenceLevel,:nda,:country,:region,:state,:city,:company_type,:companyInvestors,:classifications])
    end
    ...
    if(@page.to_i == 1.to_i)
      ...
      @from = (@page.to_i * 50.to_i).to_i - 50.to_i
    end


    if(@company_names_array2.count >  50.to_i * @page.to_i)
      @to = (50.to_i) * @page.to_i - 1.to_i
    else
      @to = @company_names_array2.count - 1
    end

    for current_iteration_number in @from..@to do
      
      @array.push(@company_names_array2[current_iteration_number])
    end
    @result = Hash.new
    @result[:records] = @array
    @result[:total] = @company_names_array2.count
    render :json =>@result
  ...
  def getCompaniesGrowth
    ...
    #sorting code
    if(@sort=='asc')
      @company_growths_array.sort_by!{ |m| m[:"#{@colmName}"] }
    else
      @company_growths_array.sort! { |x,y| y[:"#{@colmName}"] <=> x[:"#{@colmName}"] }
    end
    ...
    if(@company_growths_array.count >  50.to_i * @page.to_i)
      @to = (50.to_i) * @page.to_i - 1.to_i
    else
      @to = @company_growths_array.count - 1
    end

    for current_iteration_number in @from..@to do
      #@array[current_iteration_number] = (@company_names_array[current_iteration_number])
      @array.push(@company_growths_array[current_iteration_number])
    end
    ...
    @result = Hash.new
    @result[:records] = @array
    @result[:total] = @company_growths_array.count
    render :json =>@result
  ...
  def getCompaniesRevenue
    ...
    #sorting code
    if(@sort=='asc')
      @company_revenue_array_dollar.sort_by!{ |m| m[:"#{@colmName}"] }
      @company_revenue_array_percent.sort_by!{ |m| m[:"#{@colmName}"] }
    else
      @company_revenue_array_dollar.sort! { |x,y| y[:"#{@colmName}"] <=> x[:"#{@colmName}"] }
      @company_revenue_array_percent.sort! { |x,y| y[:"#{@colmName}"] <=> x[:"#{@colmName}"] }
    end
    ...
    #page code
    @array = Hash.new
    @arrayDollar = Array.new  
    @arrayPercent = Array.new 
    if(@page.to_i == 1.to_i)
      @from = 0.to_i
    else
      @from = (@page.to_i * 50.to_i).to_i - 50.to_i
    ...
    if(@company_revenue_array_percent.count >  50.to_i * @page.to_i)
      @to = (50.to_i) * @page.to_i - 1.to_i
    else
      @to = @company_revenue_array_percent.count - 1
    end
    ...
    for current_iteration_number in @from..@to do
      #@array[current_iteration_number] = (@company_names_array[current_iteration_number])
      @arrayPercent.push(@company_revenue_array_percent[current_iteration_number])
      @arrayDollar.push(@company_revenue_array_dollar[current_iteration_number])
      @i = @i+1
    end
    @array[:dollar] = @arrayDollar
    @array[:percent] = @arrayPercent
    @array[:total] = @company_revenue_array_percent.count
    render :json =>@array
  ...
  def getCompaniesGeo
    ...
    #sorting code
    if(@sort=='asc')
      @company_geo_array_dollar.sort_by!{ |m| m[:"#{@colmName}"] }
      @company_geo_array_percent.sort_by!{ |m| m[:"#{@colmName}"] }
    else
      @company_geo_array_dollar.sort! { |x,y| y[:"#{@colmName}"] <=> x[:"#{@colmName}"] }
      @company_geo_array_percent.sort! { |x,y| y[:"#{@colmName}"] <=> x[:"#{@colmName}"] }
    end
    ...
    if(@company_geo_array_percent.count >  50.to_i * @page.to_i)
      @to = (50.to_i) * @page.to_i - 1.to_i
    else
      @to = @company_geo_array_percent.count - 1
    end
    @i=0

    for current_iteration_number in @from..@to do
      #@array[current_iteration_number] = (@company_names_array[current_iteration_number])
      @arrayPercent.push(@company_geo_array_percent[current_iteration_number])
      @arrayDollar.push(@company_geo_array_dollar[current_iteration_number])
      @i = @i+1
    end
    @array[:dollar] = @arrayDollar
    @array[:percent] = @arrayPercent
    @array[:total] = @company_geo_array_percent.count
    render :json =>@array
