class CompaniesController < ApplicationController
    ...
    @company.each_with_index do |value, index|
      ...
      if @year == 'All'
          ...
          @company_growths.each_with_index do |v,i|
            ...
            @company_growths_hash[:GrowthRate] = v.base_growth_value
  ...
  def getCompaniesRevenue
    ...
    @company.each_with_index do |value, index|
      ...
      if @year == 'All'
        ...
        @company_revenue = CompanyRevenue.where(:company_id=>value.id,:year=>2014)
          ...
          if @company_revenue
            @company_revenue_hash = Hash.new  

            @company_revenue_hash[:company_name] = value.name
            @company_revenue.each_with_index do |v,i|
              
              if(v.revenue_id==1)
                @company_revenue_hash[:index_1_1] = (v.value==0)?0:v.value
                @company_revenue_hash[:index_1_2] = (@compRev.base_value!='')?((@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i):0
              elsif(v.revenue_id==2)
                @company_revenue_hash[:index_2_1] = (v.value==0)?0:v.value
                @company_revenue_hash[:index_2_2] = (@compRev.base_value!='')?((@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i):0
              elsif(v.revenue_id==3)
                @company_revenue_hash[:index_3_1] = (v.value==0)?0:v.value
                @company_revenue_hash[:index_3_2] = (@compRev.base_value!='')?((@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i):0
              elsif(v.revenue_id==4)
                @company_revenue_hash[:index_4_1] = (v.value==0)?0:v.value
                @company_revenue_hash[:index_4_2] = (@compRev.base_value!='')?((@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i):0
              elsif(v.revenue_id==5)
                @company_revenue_hash[:index_5_1] = (v.value==0)?0:v.value
                @company_revenue_hash[:index_5_2] = (@compRev.base_value!='')?((@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i):0
              elsif(v.revenue_id==6)
                @company_revenue_hash[:index_6_1] = (v.value==0)?0:v.value
                @company_revenue_hash[:index_6_2] = (@compRev.base_value!='')?((@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i):0
              elsif(v.revenue_id==7)
                @company_revenue_hash[:index_7_1] = (v.value==0)?0:v.value
                @company_revenue_hash[:index_7_2] = (@compRev.base_value!='')?((@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i):0
              elsif(v.revenue_id==8)
                @company_revenue_hash[:index_8_1] = (v.value==0)?0:v.value
                @company_revenue_hash[:index_8_2] = (@compRev.base_value!='')?((@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i):0
              end
            end

            @company_revenue_array[index] = @company_revenue_hash
          end
      else
        @company_growths = BaseValue.where('base_value BETWEEN ? AND ? AND year = ? AND company_id = ?  AND revenue_type = 1',params[:min],params[:max],@year,value.id)
        ...
        if @company_growths.count > 0
          ...
          if @company_revenue
            ...
            @company_revenue.each_with_index do |v,i|
              if(v.revenue_id==1)
                @company_revenue_hash[:index_1_1] = (v.value==0)?0:v.value
                @company_revenue_hash[:index_1_2] = (@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i
              elsif(v.revenue_id==2)
                @company_revenue_hash[:index_2_1] = (v.value==0)?0:v.value
                @company_revenue_hash[:index_2_2] = (@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i
              elsif(v.revenue_id==3)
                @company_revenue_hash[:index_3_1] = (v.value==0)?0:v.value
                @company_revenue_hash[:index_3_2] = (@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i
              elsif(v.revenue_id==4)
                @company_revenue_hash[:index_4_1] = (v.value==0)?0:v.value
                @company_revenue_hash[:index_4_2] = (@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i
              elsif(v.revenue_id==5)
                @company_revenue_hash[:index_5_1] = (v.value==0)?0:v.value
                @company_revenue_hash[:index_5_2] = (@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i
              elsif(v.revenue_id==6)
                @company_revenue_hash[:index_6_1] = (v.value==0)?0:v.value
                @company_revenue_hash[:index_6_2] = (@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i
              elsif(v.revenue_id==7)
                @company_revenue_hash[:index_7_1] = (v.value==0)?0:v.value
                @company_revenue_hash[:index_7_2] = (@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i
              elsif(v.revenue_id==8)
                @company_revenue_hash[:index_8_1] = (v.value==0)?0:v.value
                @company_revenue_hash[:index_8_2] = (@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i
              end
            end
    ...
    @company_revenue_array = @company_revenue_array-["",nil]
      ...
      @compRev =  BaseValue.where('year = ? AND company_id = ? AND revenue_type = 1',2014,value.id).first
          ...
          if @company_geo
            ...
            @company_geo.each_with_index do |v,i|
              ...
              `if(v.geo_id==1)
                @company_geo_hash[:index_1_1] = (v.value==0)?0:v.value 
                @company_geo_hash[:index_1_2] = (@compRev)?((@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i):0
              elsif(v.geo_id==2)
                @company_geo_hash[:index_2_1] = (v.value==0)?0:v.value
                @company_geo_hash[:index_2_2] = (@compRev)?((@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i):0
              elsif(v.geo_id==3)
                @company_geo_hash[:index_3_1] = (v.value==0)?0:v.value
                @company_geo_hash[:index_3_2] = (@compRev)?((@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i):0
              elsif(v.geo_id==4)
                @company_geo_hash[:index_4_1] = (v.value==0)?0:v.value
                @company_geo_hash[:index_4_2] = (@compRev)?((@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i):0
              elsif(v.geo_id==5)
                @company_geo_hash[:index_5_1] = (v.value==0)?0:v.value
                @company_geo_hash[:index_5_2] = (@compRev)?((@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i):0
              elsif(v.geo_id==6)
                @company_geo_hash[:index_6_1] = (v.value==0)?0:v.value
                @company_geo_hash[:index_6_2] = (@compRev)?((@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i):0
              elsif(v.geo_id==7)
                @company_geo_hash[:index_7_1] = (v.value==0)?0:v.value
                @company_geo_hash[:index_7_2] = (@compRev)?((@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i):0
              elsif(v.geo_id==8)
                @company_geo_hash[:index_8_1] = (v.value==0)?0:v.value
                @company_geo_hash[:index_8_2] = (@compRev)?((@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i):0
              elsif(v.geo_id==9)
                @company_geo_hash[:index_9_1] = (v.value==0)?0:v.value
                @company_geo_hash[:index_9_2] = (@compRev)?((@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i):0
              elsif(v.geo_id==10)
                @company_geo_hash[:index_10_1] = (v.value==0)?0:v.value
                @company_geo_hash[:index_10_2] = (@compRev)?((@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i):0
              elsif(v.geo_id==11)
                @company_geo_hash[:index_11_1] = (v.value==0)?0:v.value
                @company_geo_hash[:index_11_2] = (@compRev)?((@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i):0
              end`
            end
        ...
        if @company_growths.count > 0
          ...
          if @company_geo
            @company_geo_hash = Hash.new  

            @company_geo_hash[:company_name] = value.name
            @company_geo.each_with_index do |v,i|
              if(v.geo_id==1)
                @company_geo_hash[:index_1_1] = (v.value==0)?0:v.value 
                @company_geo_hash[:index_1_2] = (@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i
              elsif(v.geo_id==2)
                @company_geo_hash[:index_2_1] = (v.value==0)?0:v.value
                @company_geo_hash[:index_2_2] = (@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i
              elsif(v.geo_id==3)
                @company_geo_hash[:index_3_1] = (v.value==0)?0:v.value
                @company_geo_hash[:index_3_2] = (@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i
              elsif(v.geo_id==4)
                @company_geo_hash[:index_4_1] = (v.value==0)?0:v.value
                @company_geo_hash[:index_4_2] = (@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i
              elsif(v.geo_id==5)
                @company_geo_hash[:index_5_1] = (v.value==0)?0:v.value
                @company_geo_hash[:index_5_2] = (@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i
              elsif(v.geo_id==6)
                @company_geo_hash[:index_6_1] = (v.value==0)?0:v.value
                @company_geo_hash[:index_6_2] = (@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i
              elsif(v.geo_id==7)
                @company_geo_hash[:index_7_1] = (v.value==0)?0:v.value
                @company_geo_hash[:index_7_2] = (@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i
              elsif(v.geo_id==8)
                @company_geo_hash[:index_8_1] = (v.value==0)?0:v.value
                @company_geo_hash[:index_8_2] = (@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i
              elsif(v.geo_id==9)
                @company_geo_hash[:index_9_1] = (v.value==0)?0:v.value
                @company_geo_hash[:index_9_2] = (@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i
              elsif(v.geo_id==10)
                @company_geo_hash[:index_10_1] = (v.value==0)?0:v.value
                @company_geo_hash[:index_10_2] = (@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i
              elsif(v.geo_id==11)
                @company_geo_hash[:index_11_1] = (v.value==0)?0:v.value
                @company_geo_hash[:index_11_2] = (@compRev.base_value / 100) * ((v.value==0)?0:v.value).to_i
              end
            end
            @company_geo_array[index] = @company_geo_hash
          end
        end`
      end
    end
