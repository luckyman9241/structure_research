...
angular.module('myApp.controllers.dashboard', ['ui-rangeSlider','ui.bootstrap'])
  ...
  .controller('DashboardController', ['localStorageService','companyModel','$scope','dashboardModel','homeModel','$location','$templateCache','$route','CONFIGS','$http','ngProgress','$filter',function(localStorageService,companyModel,$scope,dashboardModel,homeModel,$location,$templateCache,$route,CONFIGS,$http,ngProgress,$filter) {
    ...
    $scope.dashboardModel.companyPageSort = 'asc';
    $scope.dashboardModel.companyPageSortIndex = 'name';

    $scope.dashboardModel.companyGroPage = 1;
    $scope.dashboardModel.companyGroPageSort = 'asc';
    $scope.dashboardModel.companyGroPageSortIndex = 'company_name';

    $scope.dashboardModel.companyGeoPage = 1;
    $scope.dashboardModel.companyGeoPageSort = 'asc';
    $scope.dashboardModel.companyGeoPageSortIndex = 'company_name';
    
    $scope.dashboardModel.companySegPage = 1;
    $scope.dashboardModel.companySegPageSort = 'asc';
    $scope.dashboardModel.companySegPageSortIndex = 'company_name';
    ...
    $scope.addCompanyGeoPage=function(){
      ...
      //get companies
      $http({method:'GET',url:CONFIGS.URL+'/companies',headers : {'Content-Type':'application/json; charset=UTF-8'}})
            .success(function(data, status, headers, config){
              $scope.dashboardModel.Allcompanies = data;
              ngProgress.complete();
              ngProgress.stop();
        })
            .error(function(data, status, headers, config){
    ...
    $scope.filterCompanies=function(){
        ...
        //companies
        $http({method:'GET',url:CONFIGS.URL+'/companies/getbyName/'+m+'/'+c+'/'+r+'/'+y+'/'+min+'/'+max+'/'+page+'/'+dashboardModel.companyPageSort+'/'+dashboardModel.companyPageSortIndex,headers : {'Content-Type':'application/json; charset=UTF-8'}})
        .success(function(data, status, headers, config){
        ...
        //companies growth
        $http({method:'GET',url:CONFIGS.URL+'/companies/getCompaniesGrowth/'+m+'/'+c+'/'+r+'/'+y+'/'+min+'/'+max+'/'+dashboardModel.companyGroPage+'/'+dashboardModel.companyGroPageSort+'/'+dashboardModel.companyGroPageSortIndex,headers : {'Content-Type':'application/json; charset=UTF-8'}})
          .success(function(data, status, headers, config){
        ...
        //companies geo
        $http({method:'GET',url:CONFIGS.URL+'/companies/getCompaniesGeo/'+m+'/'+c+'/'+r+'/'+y+'/'+min+'/'+max+'/'+dashboardModel.companyGeoPage+'/'+dashboardModel.companyGeoPageSort+'/'+dashboardModel.companyGeoPageSortIndex,headers : {'Content-Type':'application/json; charset=UTF-8'}})
          .success(function(data, status, headers, config){
        ...
        //companies revenue
        $http({method:'GET',url:CONFIGS.URL+'/companies/getCompaniesRevenue/'+m+'/'+c+'/'+r+'/'+y+'/'+min+'/'+max+'/'+dashboardModel.companySegPage+'/'+dashboardModel.companySegPageSort+'/'+dashboardModel.companySegPageSortIndex,headers : {'Content-Type':'application/json; charset=UTF-8'}})
          .success(function(data, status, headers, config){
    ...
    $scope.loadCompaniesGrwothByPage = function(){
        ...
        if (!dashboardModel.selected_year_filter)
          y='All';
      //companies growth
        $http({method:'GET',url:CONFIGS.URL+'/companies/getCompaniesGrowth/'+m+'/'+c+'/'+r+'/'+y+'/'+min+'/'+max+'/'+page+'/'+dashboardModel.companyGroPageSort+'/'+dashboardModel.companyGroPageSortIndex,headers : {'Content-Type':'application/json; charset=UTF-8'}})
          .success(function(data, status, headers, config){
    ...
    $scope.loadCompaniesGeoByPage = function(){
        ...
        if (!dashboardModel.selected_year_filter)
          y='All';
        //companies geo
        $http({method:'GET',url:CONFIGS.URL+'/companies/getCompaniesGeo/'+m+'/'+c+'/'+r+'/'+y+'/'+min+'/'+max+'/'+page+'/'+dashboardModel.companyGeoPageSort+'/'+dashboardModel.companyGeoPageSortIndex,headers : {'Content-Type':'application/json; charset=UTF-8'}})
          .success(function(data, status, headers, config){
            $scope.dashboardModel.companies_geos_fullData = data;
            $scope.dashboardModel.compGeoTotal = data.total;
            if($scope.dashboardModel.geoViewFlag==1){
              $scope.dashboardModel.companies_geos=data.percent;
            } else{
              $scope.dashboardModel.companies_geos=data.dollar;
            }
    ...
    $scope.loadCompaniesSegmentByPage = function(){
        ...
        if (!dashboardModel.selected_year_filter)
          y='All';
      //companies revenue
        $http({method:'GET',url:CONFIGS.URL+'/companies/getCompaniesRevenue/'+m+'/'+c+'/'+r+'/'+y+'/'+min+'/'+max+'/'+page+'/'+dashboardModel.companySegPageSort+'/'+dashboardModel.companySegPageSortIndex,headers : {'Content-Type':'application/json; charset=UTF-8'}})
          .success(function(data, status, headers, config){
            $scope.dashboardModel.companies_revenue_fullData = data;
            $scope.dashboardModel.compSegTotal = data.total;
            //$scope.dashboardModel.companies_revenue=data.dollar;
            if($scope.dashboardModel.segmentViewFlag==1){
              $scope.dashboardModel.companies_revenue=data.percent;
            } else{
              $scope.dashboardModel.companies_revenue=data.dollar;
            }
            ngProgress.complete();
  ...
  $scope.getCompanyDetail=function(companyId,index){
    ...
    $scope.getAllComp=function(){
      ...
      $scope.sorder = function(predicate,tab) {
        if(tab=='growth'){
          $scope.predicate=predicate;  
          $scope.changeSorting(predicate);
          $scope.dashboardModel.companyGroPageSortIndex = predicate;
          $scope.dashboardModel.companyGroPageSort = ($scope.sort.descending==true)?'desc':'asc';
          $scope.dashboardModel.companyGrowths = [];
          $scope.loadCompaniesGrwothByPage();
        }
        if(tab=='geo'){
          $scope.predicate=predicate;  
          $scope.changeSorting(predicate);
          $scope.dashboardModel.companyGeoPageSortIndex = predicate;
          $scope.dashboardModel.companyGeoPageSort = ($scope.sort.descending==true)?'desc':'asc';
          $scope.dashboardModel.companies_geos = [];
          $scope.loadCompaniesGeoByPage();
        }
        if(tab=='segment'){
          $scope.predicate=predicate;  
          $scope.changeSorting(predicate);
          $scope.dashboardModel.companySegPageSortIndex = predicate;
          $scope.dashboardModel.companySegPageSort = ($scope.sort.descending==true)?'desc':'asc';
          $scope.dashboardModel.companies_revenue = [];
          $scope.loadCompaniesSegmentByPage();
        }
        if(tab=='company'){
          $scope.predicate=predicate;  
          $scope.changeSorting(predicate);
          $scope.dashboardModel.companyPageSortIndex = predicate;
          $scope.dashboardModel.companyPageSort = ($scope.sort.descending==true)?'desc':'asc';
          $scope.dashboardModel.companies = [];
          $scope.loadCompaniesByPage();
        }
